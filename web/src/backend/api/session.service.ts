...
export class SessionService {
    ...
    /**
     * Login by username and password returning session with JWT token.
     * @param credentials 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public sessionPost(credentials: Credentials, observe?: 'body', reportProgress?: boolean): Observable<Session>;
    public sessionPost(credentials: Credentials, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Session>>;
    public sessionPost(credentials: Credentials, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Session>>;
    public sessionPost(credentials: Credentials, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (credentials === null || credentials === undefined) {
            throw new Error('Required parameter credentials was null or undefined when calling sessionPost.');
        }
        ...
        return this.httpClient.post<Session>(`${this.configuration.basePath}/session`,
            credentials,
            {
