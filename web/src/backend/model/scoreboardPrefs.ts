...
export interface ScoreboardPrefs { 
    /**
     * Background scoreboard color.
     */
    bg: string;
    /**
     * Foreground scoreboard color.
     */
    fg: string;
    /**
     * Set label text.
